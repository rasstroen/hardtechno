		...
		<div>
			<div class="right_news">
				<div class="newssubblock">
					<a href="/news/418" title="СЕГОДНЯ ДНЁМ - ЕЩЁ ОДИН БИЛЕТ НА РЕЙВ !" onfocus="this.blur()">
						<img border="0" alt="СЕГОДНЯ ДНЁМ - ЕЩЁ ОДИН БИЛЕТ НА РЕЙВ !" src="/upload/news/418.jpg">
							<span class="comcount">0&nbsp;комментариев&nbsp;</span>
						</a>
					</div>
